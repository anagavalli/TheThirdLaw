...
protected:
	...
	/** PBB keep track of idx for easy removal */
	int _idx;
	int _version;
...
#pragma mark BodyDef Methods
	...
	/** PBB get idx for easy removal */
	int getIdx() const { return _idx; }
	/** PBB set idx for easy removal */
	void setIdx(int index) { _idx = index; }
	/** PBB get version for recall */
	int getVersion() const { return _version; }
	/** PBB set version for recall */
