...
void BasicPhysics::init(float moveSpeed) {
	_moveSpeed = moveSpeed;
}

void BasicPhysics::move(void *obj, bool isNewResp, cugl::Vec2 direction, cugl::Vec2 *dispVec) {
...
void BasicPhysics::onCollide(void *obj, cugl::Vec2 normalVec) {
	return;
	/*PhysicalObject *physObj = (PhysicalObject*)obj;
