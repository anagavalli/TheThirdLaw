...
private:
    ...
    // TOUCH SUPPORT
	/** Notify our update routine that a new touch event was received */
	bool _touchProc;
...
#pragma mark Input Results
	...
	/**
	* Returns true if the mouse was pressed.
	*
	* @return true if the mouse was pressed.
	*/
	bool didTouch() const { return _touchProc; }

	/**
	* Mark that we have processed the new touch.
	*
	* @mark that we have processed the new touch.
	*/
	void resetTouch() { _touchProc = false;  }

	/**
	* Returns the x,y coords of touch.
	*
	* @return x,y coords of touch.
	*/
	cugl::Vec2 getTouchLoc() const { return _dtouch; }
...
#pragma mark Mouse Callbacks
	...
	*/
	void mouseBeganCB(const cugl::MouseEvent& event, bool focus);
	...
	* @param event The associated event
	*/
	void mouseEndedCB(const cugl::MouseEvent& event, bool focus);
