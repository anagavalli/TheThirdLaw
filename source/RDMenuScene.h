...
//  Version: 1/10/17
//
#ifndef __RD_MENU_SCENE_H__
#define __RD_MENU_SCENE_H__
#include <cugl/cugl.h>
...
//    /** The "settings" button */
//    std::shared_ptr<cugl::Button> _settingsButton;
    bool _playPressed;
    bool _levelsPressed;
    bool _settingsPressed;
...
public:
    ...
    bool isPlay() const { return _playPressed; }
    bool isLevels() const { return _levelsPressed; }
    bool isSettings() const { return _settingsPressed; }
...
#pragma mark Constructors
     ...
     */
    MenuScene() : Scene(), _progress(0.0f) {}
